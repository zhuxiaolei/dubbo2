Dubbo2 now means Dubbo,Dubbox eXtensions. If you know java, javax, log4j and dubbo dubbox dubbo2, you know what dubbo2 is :)
...
详见：https://github.com/zhuxiaolei/dubbo2/releases

* **dubbo2-1.0**：
	* 在dubbox2.8.4基础上
    * 增加log4j2支持(朱肖磊) 借鉴（杨俊明）的修改
    

## 依赖

从dubbo2-1.0开始，所有依赖库的使用方式将和dubbo原来的一样：即如果要使用REST、Kyro、FST、Jackson等功能，需要用户自行手工添加相关的依赖。例如：
